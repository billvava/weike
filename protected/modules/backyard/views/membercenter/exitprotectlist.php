...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main">
            <div class="row">
            	<div class="col-lg-12">
            		<h3 class="page-header"><i class="fa fa-laptop"></i> 退保管理</h3>
            		<ol class="breadcrumb">
			...
			<!--
            <form method="post" action="<?php echo $this->createUrl("membercenter/exitprotectlist")?>">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><div align="center">退保状态</div></th>
								<th><div align="center">退保金额</div></th>
                        ...
                        <tbody>
                            ...
                            <tr style="color:#666;">
                                ...
                                <td><div align="center" style=" color:green; font-weight:bold;">申请退保</div></td>
								<td><div align="center" style=" color:green; font-weight:bold;"><?php echo @$usermsg->JoinProtectPlanMoney;?></div></td>
								<td><div align="center"><?php echo date('Y-m-d H:i:s',$item->time);?></div></td>
                                <td><div align="center"><?php echo @$item->status==1?"<span style='color:green;'>通过</span>":"<span style='color:red;'>未通过</span> <a href='".$this->createUrl('membercenter/letExitprotectPass',array('authid'=>$item->uid))."'>手动通过</a>";?></div></td>
                                <td><div align="center"><a onclick="if(confirm('您确定要删除吗？删除后将无法恢复！')) return true; else return false;" href="<?php echo $this->createUrl('membercenter/exitprotectdel',array('id'=>$item->uid));?>">删除</a></div></td>
                            </tr>
                            <?php
                                }
                            ?>
