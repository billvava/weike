        					...
        					<div class="panel panel-default">
        						<div class="panel-body inbox-menu">
        							...
        							<ul>
                                        ...
                                        <li>
        									<a>帐户豆豆：<font style="font-weight:bold; font-size:14px; color:red;"><?php echo $userinfo->MinLi;?></font>&nbsp;&nbsp;个<font class="giveMinLi" style="color:#57A0FF; cursor: pointer;" alt="<?php echo $userinfo->id;?>">&nbsp;&nbsp;&nbsp;&nbsp;修改</font></a>
        								</li>
                                        <li>
        									<a>商保金额：
