...
<!--接手付款步骤区域iframe-->
    ...
    <div class="PaystepArea lastStep"><!--PaystepArea start-->
        ...
        <div class="hbitem">
          ...
          <input type="hidden" id="txtGoodsUrl" name="txtGoodsUrl" checkRes="1" class="pc11 inputp s36_ts" placeholder="商品链接地址" style=" width:300px; text-indent: 10px; height:30px; line-height:30px;" />
    ...
    $(function(){
        ...
        $(".cetainStepComplete").click(function(){
            ...
            $.ajax({
    			...
    			data:{"url3":url3,"url4":url4,"url55":url55,"url5":url5,"url6":url6,"url7":url7,"url8":url8,"taskid":$(this).attr("lang"),"orderNumber":orderNumber},
