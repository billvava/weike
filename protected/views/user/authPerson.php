...
<div class="main" style="margin-bottom: 20px;"><!--main start-->
    <div class="rzTitle"><!--rzTitle start-->
        <ul>
            ...
            <li><a href="javascript:;" class="taoneimoAuth">淘内幕关联认证</a></li>
    ...
    <div class="rzContent"><!--rzContent start-->
         ...
         <div class="fillInfo"><!--fillInfo start-->
              ...
              <table border="0" class="personRzStep1" cellspacing="0" cellpadding="0" style="width:95%; margin:0 20px; line-height:40px; margin-top:20px; background:url(<?php echo ASSET_URL;?>Auth/images/warning.png) no-repeat 560px 0px;">
                ...
                <tr>
                  <td><div align="right"><font>* </font>收款财付通帐号：</div></td>
                  <td><input type="text" name="cftaccount" id="cftaccount" class="normalInput" /></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td><div align="right"><font>* </font>收款支付宝帐号：</div></td>
                ...
                <tr>
                  <td><div align="right"><font>* </font>绑定收货地址：</div></td>
                  <td>
                ...
                <tr>
                  ...
                  <td><img src="<?php echo ASSET_URL;?>Auth/images/rzimg02.jpg" style="margin-bottom:20px;" align="left" />　<span class="introduceinfo">本人手持身份证正面拍照！</span></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td><div align="right"><font>* </font>本人生活照：</div></td>
                  ...
                  <td><img src="<?php echo ASSET_URL;?>Auth/images/rzimg03.jpg" style="margin-bottom:20px;" align="left" />　<span class="introduceinfo">身份证对应本人生活照</span></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
    ...
    $(function(){
        $(".sendStep1").click(function(){
            ...
            if($("#cftaccount").val()=="")
            {
                ...
                layer.tips('财付通帐号不能为空', '#cftaccount');
                exit;
            }
            if($("#zfbaccount").val()=="")
            {
            ...
            if($("#lifephoto").val()=="")
            {
                ...
                layer.tips('本人生活照照片不能为空', '#lifephoto');
                exit;
            }
