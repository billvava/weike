                  ...
                  <ul class="pc1" id="ppuul">
                    ...
                    <li class="s34">
                      <select name="ddlOKDay" id="ddlOKDay" class="ui-select zhsr">
                        ...
                        <option value="1" <?php if(@$teminfo && @$teminfo->ddlOKDay==1) echo "selected='selected'"?>>24小时(基本金币×1.5+0)</option>
                        <option value="2" <?php if(@$teminfo && @$teminfo->ddlOKDay==2) echo "selected='selected'"?>>48小时(基本金币×1.5+1)</option>
                        <option value="3" <?php if(@$teminfo && @$teminfo->ddlOKDay==3) echo "selected='selected'"?>>72小时(基本金币×1.5+2)</option>
                        <option value="4" <?php if(@$teminfo && @$teminfo->ddlOKDay==4) echo "selected='selected'"?>>96小时(基本金币×1.5+3)</option>
                        <option value="5" <?php if(@$teminfo && @$teminfo->ddlOKDay==5) echo "selected='selected'"?>>120小时(基本金币×1.5+4)</option>
                        <option value="6" <?php if(@$teminfo && @$teminfo->ddlOKDay==6) echo "selected='selected'"?>>144小时(基本金币×1.5+5)</option>
                        <option value="7" <?php if(@$teminfo && @$teminfo->ddlOKDay==7) echo "selected='selected'"?>>168小时(基本金币×1.5+6)</option>
                      </select>
                    </li>
                  </ul>
                </div>
