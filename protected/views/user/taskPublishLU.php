                  ...
                  <ul class="pc1" id="ppuul">
                    ...
                    <li class="s34">
                      <select name="ddlOKDay"  id="ddlOKDay" class="ui-select zhsr">
                        ...
                        <option value="1">24小时(0金币)</option>
                        <option value="2">48小时(0金币)</option>
                        <option value="3">72小时(0金币)</option>
                        <option value="4">96小时(基础金币+1)</option>
                        <option value="5">120小时(基础金币+2)</option>
                        <option value="6">144小时(基础金币+3)</option>
                        <option value="7">168小时(基础金币+4)</option>
                      </select>
                    </li>
                  </ul>
                </div>
      ...
      <div id="screen" data-step="4" data-intro="筛选出您想要的接手（接手人）">
        ...
        <div class="scmain">
          ...
          <ul class="pdul">
            ...
            <li class="scli2">此等级以上可接任务<span>（支付<font class="pdfo">0.1 - 1</font>个金币）</span></li>
          </ul>
          <ul class="pduzz">
            <li>
