         ...
         <div class="d_qie3">
            ...
            <div class="d_yhyinchang">
                ...
                <div class="d_cz clearfix">
                    <div class="d_cz_left">
                        <div class="d_czzhanghao clearfix"><p class="d_zhp">支付宝收款账号：</p><span class="d_zhspan">18824403460</span></div>
                        <div class="d_czxingming clearfix"><p>支付宝收款姓名：</p><span class="d_czn">吴安康</span><span class="d_name1">转账时请核实收款姓名</span></div>
						<div class="d_czjiaoyihao clearfix">
                            <p>充值金额：</p>
                                <input type="text" class="d_jiaoyihao_input businessMoney" placeholder="付款成功后交易金额"/>
                        </div>
                        <div class="d_czjiaoyihao clearfix">
                            <p>支付宝交易号：</p>
                                <input type="text" class="d_jiaoyihao_input businessRecord" placeholder="付款成功后交易明细里的交易号"/>
                        </div>
...
<script>
    $(function(){
        ...
        $(".payMoneyTo").click(function(){
			...
			else if($(".businessMoney").val()=="")
			{
				layer.tips('充值金额不能为空', '.businessMoney');
			}
            else{
                //输入安全码
                			...
                			success:function(msg)
                			{
                				if(msg=="SUCCESS")//安全码正确
                                {
                                    ...
                                    $.ajax({
                            			...
                            			data:{"businessRecord":$(".businessRecord").val(),"businessMoney":$(".businessMoney").val()},
                            			success:function(msg)
                            			{
                            			     if(msg=="SUCCESS")//充值成功
                                             {
											 ...
											 else if(msg=="ERRORMONEY")
											{
												  //询问框
                                            	layer.confirm('<span style="color:red;">充值失败，请确认充值金额和交易号是否正确</span>', {
                                           		   btn: ['知道了'] //按钮
                                            	},function(){
                                            	   location.reload();//重新加载当前页面
                                            	});
